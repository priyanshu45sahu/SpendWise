  ...
  return (
    <>
      <div className="container ">
        <div className="row mt-3 mb-3 d-flex justify-content-around">
        ...
        <div className="row mt-3 mb-3 d-flex justify-content-around">
          <div className="col-md-4">
            ...
            {categories.map((category) => {
              ...
              return (
                amount > 0 && (
                  <div key={`income-${category}`} className="card">
                    <div className="card-body  m-0 pl-3 pr-3 pt-2 pb-2">
          ...
          <div className="col-md-4 ">
            ...
            {categories.map((category) => {
              ...
              return (
                amount > 0 && (
                  <div key={`expense-${category}`} className="card">
                    <div className="card-body m-0 pl-3 pr-3 pt-2 pb-2">
                      <h5 className="text-capitalize">{category}</h5>
                      <Progress
